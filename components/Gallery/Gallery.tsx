...
const Gallery = () => {
	...
	function galleryAnimatorController() {
		if (
			...
			galleryArea.getBoundingClientRect().top <
	...
	function galleryArchiveAnimatorController() {
		if (
			...
			galleryArchive.getBoundingClientRect().top <
				window.innerHeight - screen.height / 2
		) {
		...
		<section className={styles.wrapper}>
			...
			<div className={styles.main}>
				<div className={styles.about}>
					...
					<div
						className={styles.block}
						style={{ "--delay": ".4" } as CSSProperties}
					>
				...
				<div
					...
					style={{ "--delay": ".6" } as CSSProperties}
				>
					...
					<div
						className={styles.block}
						style={{ "--delay": ".8" } as CSSProperties}
					>
					...
					<div
						className={styles.block}
						style={{ "--delay": "1.2" } as CSSProperties}
					>
			...
			<div className={styles.additive}>
				...
				<div className={styles.gallery}>
					<div className={combineClasses(styles.back, styles.branch)}>
						...
						<div
							className={styles.case}
							style={{ "--delay": "1.5" } as CSSProperties}
						>
							<Image src={poster} layout="fill" objectFit="contain" />
						</div>
					</div>
